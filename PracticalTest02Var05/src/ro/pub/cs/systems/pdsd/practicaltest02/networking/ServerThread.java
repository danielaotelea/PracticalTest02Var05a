...
public class ServerThread extends Thread {
	...
	private HashMap<String, ValueInfo> data = null;
	...
	public ServerThread(int port) {
		...
		this.data = new HashMap<String, ValueInfo>();
	}
	...
	public synchronized void setData(String cheie, ValueInfo vals) {
		this.data.put(cheie, vals);
	}
	
	public synchronized HashMap<String, ValueInfo> getData() {
		return data;
	}
